...
public class Winzard extends Application{
	...
	private void criarPasso2() {
		Button passoAnterior = new Button("<< VoltarIr p/ Passo 1");
	...
	private void criarPasso3() {
		Button passoAnterior = new Button("<< VoltarIr p/ Passo 2");
		passoAnterior.setOnAction(e -> {
			janela.setScene(passo2);
			janela.setTitle("Wizard :: Passo 2");
		});
